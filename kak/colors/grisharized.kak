...
evaluate-commands %sh{
    ...
    new_color="rgb:bdae37"
    new_color2="rgb:449196"

    echo "
        # then we map them to code face global value
        face global value      ${grey_light}
        face global type       ${new_color}
        ...
        face global operator   ${new_color2}
        face global attribute  ${grey_light}
        face global comment    ${grey_medium}
        face global meta       ${grey_light}
        face global builtin    ${new_color2}
